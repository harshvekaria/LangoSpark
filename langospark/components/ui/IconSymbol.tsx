...
export function IconSymbol({
  ...
  // Extract any text-specific style props and apply them correctly
  if (style) {
    // If a style is provided, wrap the icon in a View with the ViewStyle
    return (
      <View style={style}>
  ...
  // Otherwise just render the icon directly
